 ...
 */
final class Version20250709220158 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE reminders (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, due_date DATETIME NOT NULL, type VARCHAR(50) NOT NULL, priority VARCHAR(20) NOT NULL, is_triggered TINYINT(1) NOT NULL, is_done TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, triggered_at DATETIME DEFAULT NULL, metadata JSON DEFAULT NULL, user_id INT NOT NULL, event_id INT NOT NULL, INDEX IDX_6D92B9D4A76ED395 (user_id), INDEX IDX_6D92B9D471F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE reminder (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, description LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, due_date DATETIME NOT NULL, is_done TINYINT(1) NOT NULL, is_triggered TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, triggered_at DATETIME DEFAULT NULL, type VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, priority VARCHAR(20) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, send_email TINYINT(1) NOT NULL, show_notification TINYINT(1) NOT NULL, play_sound TINYINT(1) NOT NULL, metadata JSON DEFAULT NULL, user_id INT NOT NULL, event_id INT DEFAULT NULL, INDEX IDX_40374F4071F7E88B (event_id), INDEX IDX_40374F40A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = '' 
        SQL);
        $this->addSql(<<<'SQL'
