 ...
 */
final class Version20250709151643 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_reservation_conflict_check ON reservation
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_reservation_conflict_check ON reservation (salle_id, date_debut, date_fin, statut)
        SQL);
    }
}
