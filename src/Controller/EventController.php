...
use App\Form\EventFormType;  // Vérifie que tu utilises bien EventFormType
use App\Repository\EventRepository;
use App\Service\EventNotificationService;  // Assure-toi d'importer le service EventNotificationService
